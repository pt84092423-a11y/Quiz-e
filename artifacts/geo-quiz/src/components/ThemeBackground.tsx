...
function CosmicBackground() {
  return (
    <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
      ...
      {/* Animated nebula */}
      <div className="absolute top-[-20%] left-[-10%] w-[500px] h-[500px] rounded-full bg-violet-600/10 blur-[80px] animate-nebula-1" />
      <div className="absolute bottom-[-20%] right-[-10%] w-[450px] h-[450px] rounded-full bg-blue-600/10 blur-[70px] animate-nebula-2" />
      <div className="absolute top-[40%] left-[60%] w-[300px] h-[300px] rounded-full bg-purple-500/8 blur-[60px] animate-nebula-3" />
      {/* Star layers */}
...
function NeonBackground() {
  return (
    <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
      ...
      {/* Neon glow blobs */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[200px] bg-pink-600/10 blur-[70px] animate-neon-pulse" />
      <div className="absolute bottom-0 left-0 w-[350px] h-[280px] bg-cyan-500/8 blur-[60px] animate-neon-pulse-2" />
      <div className="absolute top-1/2 right-0 w-[280px] h-[280px] bg-pink-500/6 blur-[55px] animate-nebula-1" />
